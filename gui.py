...
class MainWindow(QWidget):
    def __init__(self):
        ...
        # Dubbing Section (Main)
        main_dubbing_layout = QVBoxLayout()

        # Row 1: Dubbing Selection (Visible)
        ...
        main_dubbing_layout.addWidget(self.preset_group)

        # Row 2: Dubbing Settings (Collapsible)
        ...
        main_dubbing_layout.addWidget(self.dubbing_group)
        layout.addLayout(main_dubbing_layout)
